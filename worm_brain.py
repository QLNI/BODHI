...
Architecture:
  ...
  Total: 26 key neurons with 89 synapses

Each neuron fires with integer activation (0-255).
Each synapse has integer weight (-127 to +127).
...
class WormBrain:
    ...
    26 neurons, 89 synapses. Integer-only computation.
    ...
    Each synapse has:
      - weight: -127 to +127 (integer, changes with learning)
